      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">
            Saia de todos os dispositivos conectados, incluindo
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Todos os dispositivos conectados serão desconectados e
              precisarão fazer login novamente. Você será redirecionado
