...
export function ProfileForm() {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Seu perfil"
        description="Como você aparece no app. Seu avatar e nome aparecem no cabeçalho, barra lateral e onde seus colegas te veem."
      />
            ...
            {emailChangePending && (
              <p className="flex items-start gap-2 rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-700 dark:text-amber-300">
                ...
                <span>
                  ...
                  <strong>{email}</strong>. Ambos precisam confirmar antes da
