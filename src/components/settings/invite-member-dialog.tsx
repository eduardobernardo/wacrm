          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                se cadastrar (ou entrar) e participar da conta como{' '}
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto simples. Ao fechar este diálogo,
                a URL será perdida. Para compartilhar novamente, revogue
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                Slack ou qualquer canal. Nenhum serviço de e-mail necessário.
              </DialogDescription>
            </DialogHeader>
