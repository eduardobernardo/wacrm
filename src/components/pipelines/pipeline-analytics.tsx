    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        ...
        <Metric
          ...
          tooltip="Receita esperada: valor de cada negócio aberto x probabilidade da etapa. Primeira etapa ~10%, progride até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
