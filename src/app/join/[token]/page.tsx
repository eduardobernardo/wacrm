...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Verifique a URL ou peça a quem te convidou para enviar um novo.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta para enviar um novo, leva apenas alguns segundos.',
  },
  server_error: {
    title: 'Algo deu errado',
    body: 'Não foi possível verificar este convite no momento. Tente atualizar a página em instantes.',
  },
};
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                saia e crie uma nova conta com um endereço de e-mail diferente.
